#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Call me documentation build configuration file, created by
# sphinx-quickstart on Mon Aug 24 16:00:32 2020.
...
extensions = ["sphinx.ext.autodoc","sphinx_bootstrap_theme","sphinx_copybutton"]
...
htmlhelp_basename = 'ATG-help'
# -- Options for LaTeX output ---------------------------------------------
latex_elements = {'papersize': 'letterpaper','pointsize': '12pt',}
# Grouping the document tree into LaTeX files. List of tuples
# (source start file, target name, title,
#  author, documentclass [howto, manual, or own class]).
latex_documents = [(master_doc, "Call me by your reads.tex", "Call me by your reads",[author], "manual"),]
# -- Options for manual page output ---------------------------------------
# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [(master_doc, "Call me by your reads", "Crash course on genomic variant calling",[author], 1)]
